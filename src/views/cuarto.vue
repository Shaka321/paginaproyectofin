...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    <div class="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
      <img alt="feature" class="object-cover object-center h-full w-full" src="https://onedrive.live.com/embed?resid=E92AE6AD4F3C8B9%21783&authkey=%21AO0F8hkjO09qjNU&width=1200&height=720">
    </div>
